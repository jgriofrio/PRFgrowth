---
title: "PRFgrowth - Height and height growth rate models for mixedwoods in the Petawawa Reasearch Forest"
...
library(knitr)
names <- c("Jose Riofrio", "Joanne C. White", "Piotr Tompalski", "Nicholas Coops")

aff <- c("University of British Columbia", "Canadian Forest Service", "Canadian Forest Service", "University of British Columbia")

urls <- c(
  "https://scholar.google.com/citations?user=wpicZNsAAAAJ&hl=es",
  "https://scholar.google.ca/citations?user=bqjk4skAAAAJ&hl=en/",
  "https://scholar.google.ca/citations?user=RtYdz0cAAAAJ&hl=en/",
  "https://scholar.google.ca/citations?user=XvUF8dUAAAAJ&hl=es/"
)

df <- data.frame(Author = names, Affiliation = aff)

df$Author <- paste0("[", df$Author, "](", urls, ")")
...
[Can. J. For. Res. 52, 1334–1352.](https://cdnsciencepub.com/doi/10.1139/cjfr-2022-0055)
