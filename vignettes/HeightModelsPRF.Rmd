...
`PRFgrowth` is the implementation of growth functions development from repeat LiDAR at the Petawawa Research Forest. 

Currently, two functions are available, `Hgrowth` returns the estimate of the final top height and `HGSIndex` calculate the height growth rate index at reference height for a given period.  
